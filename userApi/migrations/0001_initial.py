    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_name', models.CharField(choices=[('fulltime/contract', 'Full-time/Contract'), ('fulltime/permanent', 'Full-time/Permanent'), ('parttime/contract', 'Part-time/Contract'), ('parttime/permanent', 'Part-time/Permanent')], default='fulltime/contract', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('personal', 'Personal'), ('company', 'Company')], default='personal', max_length=20)),
